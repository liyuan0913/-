	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					    <s:property value="#shipin.fujian"/>
					    &nbsp;&nbsp;
						<a href="#" onclick="down1('<s:property value="#shipin.fujian"/>','<s:property value="#shipin.fujian"/>')" style="font-size: 11px;color: red">下载</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					...
					<td bgcolor="#FFFFFF" align="center">
						<input type="button" value="删除" onclick="shipinDel(<s:property value="#shipin.shipinId"/>)"/>
					</td>
				</tr>
				</s:iterator>
			</table>
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 11px;">
			  <tr>
			    <td>
			      <input type="button" value="添加教学视频" style="width: 123px;" onclick="shipinAdd()" />
			    </td>
			  </tr>
		    </table>
	</body>
