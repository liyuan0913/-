  ...
  <body style="margin: 0px;">
        <div id="Menu" style="width: 190px; float: left; margin: 2px 0px 0px 2px; _margin-left: 2.5px;overflow: hidden;">
            ...
            <ul id="identifier">
				...
				<li><a class="navhead" type='Module' style="font-family: 微软雅黑;">
				<img style='vertical-align:middle' src="<%=path %>/images/group.png" />&nbsp;教员信息管理</a>
				    <ul class="navcontent">
						<li><img  style='vertical-align:middle' src="<%=path %>/images/vcard_add.png" />&nbsp;
						<a target="main" href="<%=path %>/teaMana.action" style="font-family: 微软雅黑;">教员信息管理</a></li>
						<li><img  style='vertical-align:middle' src="<%=path %>/images/table.png" />&nbsp;
						<a target="main" href="<%=path %>/admin/tea/teaAdd.jsp" style="font-family: 微软雅黑;">添加教员信息</a></li>
				    </ul>
				</li>
				<li><a class="navhead" type='Module' style="font-family: 微软雅黑;">
				...
				<li>
				    ...
				    <img style='vertical-align:middle' src="<%=path %>/images/group.png" />&nbsp;论坛版块管理</a>
				    <ul class="navcontent">
						<li><img  style='vertical-align:middle' src="<%=path %>/images/vcard_add.png" />&nbsp;
...
<body style="margin: 0px;">
        <div id="Menu" style="width: 190px; float: left; margin: 2px 0px 0px 2px; _margin-left: 2.5px;overflow: hidden;">
            ...
            <ul id="identifier">
				...
				<li><a class="navhead" type='Module' style="font-family: 微软雅黑;">
				<img style='vertical-align:middle' src="<%=path %>/images/group.png" />&nbsp;课程信息管理</a>
				    <ul class="navcontent">
						<li><img  style='vertical-align:middle' src="<%=path %>/images/vcard_add.png" />&nbsp;
						<a target="main" href="<%=path %>/admin/doc/docAdd.jsp" style="font-family: 微软雅黑;">添加课程信息</a></li>
						<li><img  style='vertical-align:middle' src="<%=path %>/images/table.png" />&nbsp;
						<a target="main" href="<%=path %>/docMana.action" style="font-family: 微软雅黑;">课程信息管理</a></li>
				    </ul>
				</li>
				<li><a class="navhead" type='Module' style="font-family: 微软雅黑;">
				...
				<li><a class="navhead" type='Module' style="font-family: 微软雅黑;">
				<img style='vertical-align:middle' src="<%=path %>/images/group.png" />&nbsp;问题答疑管理</a>
				    <ul class="navcontent">
						<li><img  style='vertical-align:middle' src="<%=path %>/images/vcard_add.png" />&nbsp;
						<a target="main" href="<%=path %>/liuyanMana.action" style="font-family: 微软雅黑;">问题答疑管理</a></li>
				    </ul>
				</li>
				...
				<li><a class="navhead" type='Module' style="font-family: 微软雅黑;">
				<img style='vertical-align:middle' src="<%=path %>/images/group.png" />&nbsp;学习测试题目管理</a>
				    <ul class="navcontent">
						<li><img  style='vertical-align:middle' src="<%=path %>/images/vcard_add.png" />&nbsp;
						<a target="main" href="<%=path %>/timuMana.action" style="font-family: 微软雅黑;">学习测试题目管理</a></li>
						<li><img  style='vertical-align:middle' src="<%=path %>/images/table.png" />&nbsp;
						<a target="main" href="<%=path %>/admin/timu/timuAdd.jsp" style="font-family: 微软雅黑;">添加学习测试题目</a></li>
				    </ul>
				</li>
				
				<li><a class="navhead" type='Module' style="font-family: 微软雅黑;">
				<img style='vertical-align:middle' src="<%=path %>/images/group.png" />&nbsp;试卷信息管理</a>
				    <ul class="navcontent">
						<li><img  style='vertical-align:middle' src="<%=path %>/images/vcard_add.png" />&nbsp;
						<a target="main" href="<%=path %>/shitiMana.action" style="font-family: 微软雅黑;">学习试卷信息管理</a></li>
						<li><img  style='vertical-align:middle' src="<%=path %>/images/table.png" />&nbsp;
						<a target="main" href="<%=path %>/admin/shiti/shitiAdd.jsp" style="font-family: 微软雅黑;">添加学习试卷信息</a></li>
						<li><img  style='vertical-align:middle' src="<%=path %>/images/table.png" />&nbsp;
						<a target="main" href="<%=path %>/admin/fenshu/shiti_fenshu_pre.jsp" style="font-family: 微软雅黑;">分数统计模块</a></li>
				    </ul>
				</li>
            </ul>
            <div style="margin-left: 2px; width: 180px; height: 28px; background-image: url('<%=path %>/images/foot.png')"></div>
        ...
        <div id="Menu" style="width: 190px; float: left; margin: 2px 0px 0px 2px; _margin-left: 2.5px;overflow: hidden;">
            ...
            <ul id="identifier">
                ...
                <img style='vertical-align:middle' src="<%=path %>/images/group.png" />&nbsp;修改我的信息</a>
                    <ul class="navcontent">
						<li><img  style='vertical-align:middle' src="<%=path %>/images/vcard_add.png" />&nbsp;
						<a target="main" href="<%=path %>/admin/userinfo/stuinfo.jsp" style="font-family: 微软雅黑;">修改我的信息</a></li>
	                </ul>
                </li>
				<li><a class="navhead" type='Module' style="font-family: 微软雅黑;">
				...
				<li><a class="navhead" type='Module' style="font-family: 微软雅黑;">
				<img style='vertical-align:middle' src="<%=path %>/images/group.png" />&nbsp;学习试题信息列表</a>
				    <ul class="navcontent">
						<li><img  style='vertical-align:middle' src="<%=path %>/images/vcard_add.png" />&nbsp;
						<a target="main" href="<%=path %>/shiti_all.action" style="font-family: 微软雅黑;">学习试题信息列表</a></li>
						<li><img  style='vertical-align:middle' src="<%=path %>/images/vcard_add.png" />&nbsp;
						<a target="main" href="<%=path %>/fenshuMine.action" style="font-family: 微软雅黑;">查询我的分数</a></li>
				    </ul>
				</li>
            </ul>
            <div style="margin-left: 2px; width: 180px; height: 28px; background-image: url('<%=path %>/images/foot.png')"></div>
