	      ...
	      <div class="content">
	          <div style="border:1px solid  #CCCCCC;width: 745px;margin-left: 10px">
		             <div style="margin: 10px;">
			             <p>信息标题：${requestScope.gonggao.gonggaoTitle }</p>
				         <p>信息内容：<c:out value="${requestScope.gonggao.gonggaoContent }" escapeXml="false"></c:out></p>
				         <p>发布时间：${requestScope.gonggao.gonggaoData }</p><br/> 
